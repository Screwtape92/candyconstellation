  ...
  create() {
    ...
    this.physics.add.overlap(this.player, this.powerups, (_player, powerup) => {
      ...
      if (pickup.collect()) {
        ...
        // listens for this to play the shared power-up-activate cue.
    ...
    // Same event-driven, no-field shape as JuiceSystem above — plays every
    // one-shot SFX cue (docs/game-design.md "Audio spec").
